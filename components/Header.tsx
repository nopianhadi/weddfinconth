            ...
            >
                ...
                <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                    ...
                    <div className="relative" ref={profileRef}>
                        ...
                        >
                            <span className="font-bold text-sm text-brand-accent">{getInitials(profile?.fullName || currentUser?.fullName || '')}</span>
                        </button>
                        ...
                        {isProfileOpen && (
                            <div className="absolute top-full right-0 mt-3 w-72 bg-brand-surface rounded-2xl shadow-2xl border border-brand-border/50 z-[60] animate-slide-down overflow-hidden">
                                <div className="p-4 border-b border-brand-border/50">
                                    <p className="font-semibold text-brand-text-light truncate">{profile?.fullName || currentUser?.fullName}</p>
                                    <p className="text-sm text-brand-text-secondary truncate">{profile?.email || currentUser?.email}</p>
                                </div>
                                <div className="p-2">
                                    <button
